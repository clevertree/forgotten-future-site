...
export default function ContactPage() {
    return (
        <div className="container mx-auto px-6 py-12 max-w-2xl text-center">
            ...
            <p className="text-sm md:text-base text-secondary mb-16 italic px-4 leading-relaxed">
            ...
            <div className="glass-panel text-left py-8 md:py-12 px-6 md:px-12">
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <p className="text-secondary text-sm">Active Monitoring. Lore Hardening in progress.</p>
                    </div>
                </div>

                <div className="mt-16 pt-8 border-t border-white/5 text-[10px] text-muted uppercase tracking-widest text-center">
