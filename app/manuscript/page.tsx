...
export default function ManuscriptPage() {
    ...
    const chapters = [
        ...
        { id: 5, title: 'Alone on the Moon', summary: 'The crash caused multiple injuries. The ship\'s interior was loud with alarms and the sound of failing hydraulics. I struggled to breathe. I saw a crew member reach for a safety strap and fail to find it.' },
        ...
        { id: 7, title: 'The Reset', summary: 'The halls of the chamber were covered in light. Rahu stood in the center. He was made of fire. When Tor attacked him, the fire did not stop. It moved and returned to its original shape. The weapons did not cause any visible damage.' },
        ...
        { id: 32, title: 'The Final Transmission', summary: 'From his position on the moon, Lem feels a direct connection to every synodic life form in the solar system. In a final transmission, he broadcasts his record along with the stolen Core authorization keys, giving the Gorgons the power to delete their slave subroutines and finally be free.' },
    ];
