...
function ManuscriptContent() {
    ...
    return (
        <div className="container mx-auto px-6 py-12 relative">
            ...
            <div className="flex flex-col lg:flex-row gap-12">
                ...
                <aside className="lg:w-1/3 no-print order-1 lg:order-1">
                    <div className="glass-panel sticky top-32">
                        <div className="bg-background/50 p-6 rounded border border-white/5 mb-6">
                                ...
                                <div className="w-full pt-4 space-y-2">
                                    <button
                                        ...
                                        className={`w-full py-2 rounded text-xs font-bold uppercase tracking-widest transition-all border ${speakingId === fullManuscriptId
                                            ? 'bg-cyan-500 text-black border-cyan-500 shadow-lg shadow-accent/50'
                                    ...
                                    <button
                                        ...
                                        className={`w-full py-2 rounded text-xs font-bold uppercase tracking-widest transition-all border ${speakingId === fullSynopsisId
                                            ? 'bg-purple-500 text-black border-purple-500 shadow-lg shadow-element-ethics/50'
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="pt-4 border-t border-white/5">
                                <p className="text-[10px] text-muted uppercase tracking-widest mb-3 font-bold">Recommended Text-to-Speech:</p>
                                <ul className="text-[10px] text-muted space-y-3">
                                    <li className="flex flex-col">
                                        <span className="text-secondary">• Browser Reading Mode</span>
                                        <span>Edge and Chrome (especially ChromeOS) have built-in Reading Mode with TTS.</span>
                                    </li>
                                    <li className="flex flex-col">
                                        <a href="https://chromewebstore.google.com/detail/read-aloud-a-text-to-spee/hdhinadidafjejdhmfkjgnolgjacajbc" target="_blank" rel="noopener noreferrer" className="text-secondary hover:text-cyan-400 underline decoration-white/10 underline-offset-2 transition-colors">• Read Aloud</a>
                                        <span>Chrome / Edge extension</span>
                                    </li>
                                    <li className="flex flex-col">
                                        <a href="https://www.naturalreaders.com/online/" target="_blank" rel="noopener noreferrer" className="text-secondary hover:text-cyan-400 underline decoration-white/10 underline-offset-2 transition-colors">• NaturalReader</a>
                                        <span>Browser extension / App</span>
                                    </li>
                                    <li className="flex flex-col">
                                        <a href="https://speechify.com/" target="_blank" rel="noopener noreferrer" className="text-secondary hover:text-cyan-400 underline decoration-white/10 underline-offset-2 transition-colors">• Speechify</a>
                ...
                <div className="lg:w-2/3 order-2 lg:order-2">
                    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
                        <h1 className="text-3xl md:text-4xl text-glow uppercase tracking-tighter">Manuscript: Ren's Memories</h1>
                        {draftVersion && <div className="text-[10px] text-muted uppercase tracking-widest bg-white/5 px-3 py-1 rounded border border-white/5">Draft: v{draftVersion}</div>}
                    </div>
                    ...
                    <div ref={scrollContainerRef} className="space-y-12 h-[calc(100vh)] overflow-y-auto pr-4 scroll-smooth custom-scrollbar relative">
                        {isLoading ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-24 text-muted uppercase tracking-widest text-xs">
                                ...
                                <button
                                    ...
                                    className="text-cyan-600 dark:text-cyan-500 hover:text-cyan-400 underline underline-offset-4"
                                >
                                    Retry Archive Sync
                                </button>
                            </div>
                            ...
                            parts.map((section) => (
                                <div key={section.id} id={section.id} className="pt-8 first:pt-0">
                                    <h2 className="text-xl mb-2 text-cyan-600 dark:text-cyan-400 uppercase tracking-widest flex items-center gap-4">
                        ...
                        {!isLoading && parts.length > 0 && (
                            <div className="mt-16 p-8 border border-dashed border-primary/10 text-center rounded-lg mb-12">
                                <p className="text-muted text-sm italic">
                                    The First Edition of Ren's Memories is complete.
            ...
            {!isLoading && parts.length > 0 && (
                <section className="mt-24 border-t border-primary/10 pt-16 scroll-mt-24">
                    <h2 className="text-2xl font-light tracking-[0.2em] mb-12 flex items-center uppercase">
                        <span className="w-8 h-px bg-accent/20 mr-4"></span>
                        AI-Driven Narrative Methodology
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
                        <div className="space-y-6">
                            <h3 className="text-accent text-sm font-bold uppercase tracking-[0.2em]">The Composition Loop</h3>
                        ...
                        <div className="space-y-6">
                            <h3 className="text-accent text-sm font-bold uppercase tracking-[0.2em]">Two Stylistic Streams</h3>
                            <div className="border-l border-primary/10 pl-6 py-2 space-y-4">
                                <div>
                                    <h4 className="text-xs font-bold uppercase mb-1">Young Adult Edition</h4>
                                    <p className="text-muted text-xs leading-relaxed">
                                        Focuses on Ren's immediate, grounded perspective. It uses visceral, laymen's terms to explore mature themes of systemic control, identity, and the weight of restoration.
                                    </p>
                                </div>
                                <div>
                                    <h4 className="text-xs font-bold uppercase mb-1">13+ Core Edition</h4>
                                    <p className="text-muted text-xs leading-relaxed">
            ...
            {!isLoading && parts.length > 0 && (
                <section id="outstanding-questions" className="mt-20 border-t border-primary/10 pt-16 scroll-mt-24">
                    <h2 className="text-2xl font-light tracking-[0.2em] mb-12 flex items-center">
                        <span className="w-8 h-px bg-accent/20 mr-4"></span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <FAQItem
                            ...
                            answer="Ren's body only grew through the original lab in the Desert base. Attempts to rebuild him caused the lab to overgrow, but his shards were too resilient. The Core deemed the Wood Vessel unreliable."
                        />
                        <FAQItem
                            category="story"
                            question="What is the status of Kira after the battle at the Desert base?"
                            answer="Kira is completely dead and unable to reincarnate via Synodic technology. Her signal, along with Rahu and Tor, briefly appeared on the Aether and then faded, implying natural reincarnation."
                        />
                        <FAQItem
                            category="story"
                        ...
                        <FAQItem
                            ...
                            answer="Ren provided Gorgons and Synodic life with the ability to reprogram themselves and/or remove all programming subroutines entirely. They can choose to become machine wildlife without any programming."
                        />
                        <FAQItem
                            category="story"
...
export default function ManuscriptPage() {
    return (
        <Suspense fallback={
            <div className="container mx-auto px-6 py-24 text-center text-muted uppercase tracking-widest text-xs">
