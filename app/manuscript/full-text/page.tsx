...
<section id="chapter-1" className="prose prose-invert max-w-none scroll-mt-32">
                    ...
                    <section id="chapter-5" className="prose prose-invert max-w-none scroll-mt-32">
                        ...
                        <div className="text-zinc-300 leading-[2] text-lg space-y-6">
                            ...
                            <p>The lunar structures were built with precise lines and angles. Large machines, the Striders, moved across the surface. The Gorgons within them were afraid. I heard it in their voices over the open frequencies. One Strider was destroyed. The radio went quiet.</p>
