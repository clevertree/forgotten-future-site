        ...
        <main className="min-h-screen selection:bg-accent/30">
            ...
            <section className="relative h-[80vh] flex items-center justify-center overflow-hidden border-b border-foreground/10">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    <div className="inline-block mb-4 px-3 py-1 border border-accent/30 bg-accent/10 text-accent-bright text-xs font-bold tracking-[0.3em] uppercase animate-pulse backdrop-blur-sm">
                        Signal Detected // Era: post-Fry
                    </div>
                    <h1 className="text-6xl md:text-8xl font-black mb-6 tracking-tighter italic">
                        STARS DIE
                    </h1>
                    <p className="text-sm md:text-lg text-primary mb-8 tracking-wide max-w-xl mx-auto leading-relaxed backdrop-blur-sm bg-background/40 p-4 rounded-lg border border-white/5 shadow-2xl">
                        A thousand years of human history, erased in a single Cataclysm.
                        A new Dark Age has begun.
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
                        <Link href="/manuscript" className="btn-primary">
                            Read Manuscript
                        </Link>
                        <Link href="/story" className="btn-secondary backdrop-blur-sm">
                            Explore Lore
                        </Link>
                    </div>
                </div>
            ...
            <section className="container mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative aspect-square bg-background/40 rounded-lg overflow-hidden border border-white/10">
                    <Image
            ...
            {/* The Elements */}
            <section className="w-full bg-background/50 py-24">
                <div className="container mx-auto px-6">
                    <h2 className="text-3xl md:text-4xl text-center mb-16 underline decoration-accent underline-offset-8">THE FIVE ELEMENTS</h2>
