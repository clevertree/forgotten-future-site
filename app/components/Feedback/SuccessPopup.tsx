...
export const SuccessPopup: React.FC<SuccessPopupProps> = ({ prUrl, onClose }) => {
    return (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-background/90 backdrop-blur-md animate-in fade-in duration-300">
            <div className="w-full max-w-md bg-[#0a0a0a] border border-cyan-500/30 rounded-xl shadow-2xl shadow-accent/20 overflow-hidden">
                <div className="p-8 text-center">
                    ...
                    <div className="space-y-3">
                        <a
                            ...
                            className="flex items-center justify-center gap-2 w-full py-3 px-6 bg-cyan-600 hover:bg-cyan-500 text-white font-bold rounded-lg transition-all shadow-lg shadow-accent/20"
                        >
                        ...
                        <button
                            onClick={onClose}
                            className="w-full py-3 px-6 text-muted hover:text-white text-sm font-bold uppercase tracking-widest transition-colors"
                        >
                            Close
                        </button>
                    </div>
                ...
                <div className="bg-background/50 py-3 px-6 border-t border-white/5 flex justify-between items-center">
                    <span className="text-[10px] text-muted uppercase tracking-widest">Protocol: Community Sync</span>
