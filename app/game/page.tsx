    ...
    return (
        <div className="container mx-auto px-6 lg:px-16 py-12">
            ...
            <section className="mb-24">
                ...
                <div className="glass-panel p-8 md:p-12 mb-12">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="flex flex-col items-center p-6 bg-foreground/5 rounded-xl border border-foreground/10 text-center">
                            ...
                            <p className="text-sm text-muted">High-fidelity environments and immersive record of the Great Fry's aftermath.</p>
                        </div>
                        <div className="flex flex-col items-center p-6 bg-foreground/5 rounded-xl border border-foreground/10 text-center">
                            ...
                            <p className="text-sm text-muted">Strategic deployment and narrative expansion via mobile-optimized interfaces.</p>
                        </div>
                        <div className="flex flex-col items-center p-6 bg-foreground/5 rounded-xl border border-foreground/10 text-center">
                            ...
                            <p className="text-sm text-muted">A persistent world that evolves across all platforms using cloud-based narrative state.</p>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div className="space-y-6">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted">Every session is inherently networked. Players are assigned to characters in a descending order of priority, starting with the primary protagonists, allowing for seamless collaborative storytelling.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted">The engine can render 2, 3, or 4+ disparate locations on a single screen simultaneously. Witness events unfolding across the globe in real-time without context switching.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted">The split-rendering model ensures that assets are always ready. There are no loading screens, transitions, or interruptions to the narrative flow.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="grid sm:grid-cols-2 gap-8">
                                <div className="space-y-3">
                                    ...
                                    <p className="text-xs text-muted leading-relaxed">Most gameplay adopts a traditional sideview perspective of the protagonist, focusing on precision movement and environmental navigation.</p>
                                </div>
                                <div className="space-y-3">
                                    <div className="flex items-center gap-2 text-cyan-600 dark:text-cyan-400">
                                        <Target size={18} />
                                    ...
                                    <p className="text-xs text-muted leading-relaxed">The character possesses a unique <strong>Focusing Ability</strong> that can lock onto any object in the 3D environment, regardless of direction.</p>
                                </div>
                            </div>
                        </div>
                        <div className="bg-foreground/5 p-6 rounded-lg border border-foreground/10 space-y-6">
            ...
            <section className="text-center py-12 border-t border-foreground/10">
                <p className="text-muted text-xs uppercase tracking-[0.4em] mb-4">Development Status: Iterative Prototype Phasing</p>
