    ...
    <div className="container mx-auto px-6 py-12">
      ...
      <section className="mb-24">
        ...
        <div className="glass-panel">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-3xl font-black mb-2 text-glow">STARS DIE</h3>
              <p className="text-cyan-500 text-sm mb-6 uppercase tracking-widest font-bold">
                Song by Porcupine Tree • 1995
              </p>
      ...
      <section className="mb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { src: '/media/teaser/hero_moon_eruption.png', title: 'The Eruption', meta: 'Day 0 Post-Reset' },
            ...
            { src: '/media/teaser/hero_disintegrating_moon.png', title: 'Lunar Decay', meta: 'After Time Night Sky' },
